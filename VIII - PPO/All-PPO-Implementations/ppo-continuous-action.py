# https://www.youtube.com/watch?v=BvZvx7ENZBw&ab_channel=Weights%26Biases
...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="HalfCheetahBulletEnv-v0",                # Modiification of ppo.py
    ...
    parser.add_argument("--repo-id", type=str, default="hishamcse/ppo-HalfCheetahBulletEnv-v0-scratch", help="id of the model repository from the Hugging Face Hub {username/repo_name}")
    ...
    for update in range(1, num_updates + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                _, newlogprob, entropy, newvalue = agent.get_action_and_value(b_obs[mb_inds], b_actions[mb_inds])    # modification of ppo.py
