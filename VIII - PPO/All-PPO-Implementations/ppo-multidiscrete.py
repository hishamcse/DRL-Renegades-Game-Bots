...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="MicrortsMining-v1",        # modification from ppo.py
        help="the id of the environment")
    parser.add_argument("--total-timesteps", type=int, default=20000000,               # modification from ppo.py
    ...
    parser.add_argument("--repo-id", type=str, default="hishamcse/ppo-MicrortsMining-v1-scratch", help="id of the model repository from the Hugging Face Hub {username/repo_name}")
